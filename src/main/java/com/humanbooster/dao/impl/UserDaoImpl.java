...
// A RETOUCHER POUR FAIRE UN USER user ET FAIRE LE TRI DANS LE SERVICE ENTRE ADMIN ET USERLAMBDA
	@Override
	@Transactional(readOnly=true)
	public boolean connectDaoUser(UserLambda user) {
		try{
		   Query query = sessionFactory.getCurrentSession().createQuery("FROM User u WHERE u.loginUser=:mail AND u.passwordUser=:pwd");
       ...
       } catch (HibernateException ex) { ex.printStackTrace(); return false; }
