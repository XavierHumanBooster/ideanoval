...
public class ClassementController {
	...
	public ModelAndView initClassementAndShowIt(Map<String, Object> map) {
		...
		// on fait la somme top, flop pour chaque id�e
		...
		// on cr�e un objet ValueComparator qui va permettre de tri�e la hashMap
		// par valeur du plus grande au plus petit
		ValueComparator comparateur = new ValueComparator(hashMap);

		// on recupere la hashMap tri�e avec un TreeMap
		TreeMap<Integer, Integer> mapTriee = new TreeMap<Integer, Integer>(comparateur);
		System.out.println("map non-tri�e: " + hashMap); // La commande suivante
															// affichera map
															// non-tri�e:
															// {A=99.5, B=67.4,
															// C=65.2}.
		...
		// on recupere que les 10 premi�res idIdea
